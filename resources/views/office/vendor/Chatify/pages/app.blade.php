...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
  <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">MESSAGES</span> </a>  <a href="{{ route('home') }}"><i class="fas fa-home"></i> <span class="home-headTitle">HOME</span> </a>
                {{-- header buttons --}}
            ...
            <div class="messenger-listView-tabs">
                <a href="#" @if($route == 'user') class="active-tab" @endif data-view="users">
                    <span class="far fa-user"></span> Peoplee</a>
