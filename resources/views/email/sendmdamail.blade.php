...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;font-weight: bold;"><span style="font-size: 14px; line-height: 19.6px;"><b>Dear {{$mdanotify['name']}},</b> </span></p>
  </div>
...
<table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 160%;  word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;text-align: justify;"><span style="font-size: 13px; line-height: 20.4px;text-align: justify;"> The 2024 Health MDA Initiative Monitoring Tool is live! Your participation is vital to the success of these initiatives. Kindly find your access details below:
      ...
      <b>Email Address:</b>  Official Email <br>
      <b>Pass:</b> {{$mdanotify['password']}} <br>

    
  <b>User Type:</b> {{$mdanotify['type']}} <br>
...
<br>
<br>
For assistance, contact Lauren Parker Team for assistance.
      <br>
      <br>
