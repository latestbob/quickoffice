...
<body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #ffffff;color: #000000">
  ...
  <tr style="vertical-align: top">
    ...
    <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color: #ffffff;"><![endif]-->
        ...
        <div class="u-row-container" style="padding: 0px;background-color: #293D34;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td style="padding-right: 0px;padding-left: 0px;" align="center">
                ...
                <img align="center" border="0" src="https://res.cloudinary.com/edifice-solutions/image/upload/v1706216565/edo_2_h0ozyo.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 16%;max-width: 200.8px;" width="200.8" class="v-src-width v-src-max-width"/>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;">Dear Partners, </span></p>
  </div>
...
<table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 160%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 12px; line-height: 20.4px;">I hope this message finds you well. Below is a summary of the Edo State Health Ministry's 2024 initiatives, evaluated using the MDA Monitoring Tool.
...
<table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <tbody style="font-size:14px;text-align:center;">
    ...
    @php
      $total = \App\Mdainitiative::where('mda','State Ministry of Health')->count();
      $complete = \App\Mdainitiative::where('mda','State Ministry of Health')->where('status','Completed')->count();

      $late = \App\Mdainitiative::where('mda','State Ministry of Health')->where('status','Late')->count();
      $complete_percent = ($complete / $total) * 100;
      
      @endphp
      <td colspan="2"style="border: 1px solid black; padding: 10px;">SMoH</td>
      <td style="border: 1px solid black;
      padding: 10px;">{{ $total }}</td>
      <td style="border: 1px solid black;
      padding: 10px;"> {{$complete_percent}}</td>
      <td style="border: 1px solid black;
      padding: 10px;"> {{$late}}</td>
    ...
    @php
      $total = \App\Mdainitiative::where('mda','Edo State Hospitals Management Agency')->count();
      $complete = \App\Mdainitiative::where('mda','Edo State Hospitals Management Agency')->where('status','Completed')->count();

      $late = \App\Mdainitiative::where('mda','Edo State Hospitals Management Agency')->where('status','Late')->count();
      $complete_percent = ($complete / $total) * 100;
      
      @endphp
      <td colspan="2"style="border: 1px solid black; padding: 10px;">HMA</td>
      <td style="border: 1px solid black;
      padding: 10px;">{{$total}}</td>
      <td style="border: 1px solid black;
      padding: 10px;"> {{$complete_percent}}</td>
    ...
    @php
      $total = \App\Mdainitiative::where('mda','Edo State Health Insurance Commission')->count();
      $complete = \App\Mdainitiative::where('mda','Edo State Health Insurance Commission')->where('status','Completed')->count();

      $late = \App\Mdainitiative::where('mda','Edo State Health Insurance Commission')->where('status','Late')->count();
      $complete_percent = ($complete / $total) * 100;
      
      @endphp


      <td colspan="2"style="border: 1px solid black; padding: 10px;">EDHIC</td>
      <td style="border: 1px solid black;
      padding: 10px;">{{$total}}</td>
      <td style="border: 1px solid black;
      padding: 10px;"> {{round($complete_percent)}}</td>
      <td style="border: 1px solid black;
      padding: 10px;"> {{$late}}</td>
    ...
    @php
      $total = \App\Mdainitiative::where('mda','Edo State Primary Health Care Development Agency')->count();
      $complete = \App\Mdainitiative::where('mda','Edo State Primary Health Care Development Agency')->where('status','Completed')->count();

      $late = \App\Mdainitiative::where('mda','Edo State Primary Health Care Development Agency')->where('status','Late')->count();
      $complete_percent = ($complete / $total) * 100;
      
      @endphp

        <td colspan="2"style="border: 1px solid black; padding: 10px;">EDSPHCDA</td>
        <td style="border: 1px solid black;
        padding: 10px;">{{$total}}</td>
        <td style="border: 1px solid black;
        padding: 10px;"> {{round($complete_percent)}}</td>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://res.cloudinary.com/edifice-solutions/image/upload/v1704801095/laurenparker_f9kszb.svg" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 20%;max-width: 116px;" width="116" class="v-src-width v-src-max-width"/>
