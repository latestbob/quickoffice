...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 140%;  word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;">Dear {{$receiver['name']}}, </span></p>
  </div>
  ...
  <div class="v-line-height" style="line-height: 140%; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;"> 
      ...
      <br><br>Your Task<i><b>"{{$receiver['task']}}"</b></i> has been reviewed and updated to the following :

      <br><br>

      <b>Status</b> : {{$receiver['status']}}, <br>
      <b>Comments</b> : {{$receiver['comment']}} <br>

      <b>Reviewed By </b> : {{$receiver['admin']}} <br>
