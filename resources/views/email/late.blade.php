...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;">Dear {{$late['owner']}}, </span></p>
  </div>
...
<table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 160%;  word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 12px; line-height: 20.4px;">I hope this message finds you well. I regret to inform you that the <b>{{$late['initiative']}} </b>initiative has surpassed its estimated completion date <b>{{$late['date']}} </b>. Timely completion is crucial for the success of the initiative.
      <br>
      <br>

      Kindly provide an update on the current status and reasons for the delay at your earliest convenience. Additionally, I recommend reaching out to the Governor's PA to schedule a meeting promptly. Discussing next steps with the Governor is imperative to address this delay effectively. 
...
<p style="font-size: 14px; line-height: 160%;"><span style="font-size: 10px; line-height: 16px;">Powered by Lauren Parker</span></p>
  </div>
