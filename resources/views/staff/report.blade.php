...
<head>
    ...
    <title>{{Auth::user()->office}} Staff - Reports</title>
                                ...
                                <table class="table table-hover table-borderless table-sm" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    @foreach($reports as $report)
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{route('staff.report.pdf',$report->id)}}"class="btn btn-info"><i class="fa fa-download" aria-hidden="true"></i>Generate Report</a><a href="#"class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></td>
