...
<head>
    ...
    <title>{{Auth::user()->office}} Staff - Employee PaySlip</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Employee Payslip</h1> 
                        <button class="btn btn-primary"data-toggle="modal" data-target="#exampleModal">New Employee Payslip</button>
                            ...
                            <div class="card py-3">
                            <h6 class="card-header card-m-0 font-weight-bold text-primary">Employee Payslip</h6>
                            </div>
                            <div class="card-body">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create New Employee Payslip</h5>
      ...
      <div class="modal-body">
        ...
        <form action="{{route('staffpayslipadd')}}" method="POST">
            @csrf


        
            <p class="font-weight-bold py-2"style="color:black;font-size:15px;">Employee Details</p>
            ...
            <div class="row  mt-2">
                ...
                <div class="col">
                        <label for="">No. of Days Worked</label>
                        <input type="number"name="days_work"class="form-control"required>
                </div>
            </div>
            ...
            <p class="font-weight-bold py-3"style="color:black;font-size:15px;">Gross Details</p>


<div class="row">
    <div class="col">
            <label for="">Annual Gross</label>
            <input type="number"name="annual_gross"step="0.01" min="0.00"class="form-control"required>
    </div>


    <div class="col">
            <label for="">Monthly Gross</label>
            <input type="number"name="monthly_gross"step="0.01" min="0.00"class="form-control"required>
    </div>
</div>
    ...
    <p class="font-weight-bold py-3"style="color:black;font-size:15px;">Earnings</p>


<div class="row">
    <div class="col">
            <label for="">Basic</label>
            <input type="number"name="basic"step="0.01" min="0.00"class="form-control"required>
    </div>


    <div class="col">
            <label for="">Housing</label>
            <input type="number"name="housing"step="0.01" min="0.00"class="form-control"required>
    </div>
</div>
...
<div class="row">
    <div class="col">
            ...
            <input type="number"name="transport"step="0.01" min="0.00"class="form-control"required>
    </div>


    <div class="col">
            <label for="">Others</label>
            <input type="number"name="others"step="0.01" min="0.00"class="form-control">
    </div>
</div>


<p class="font-weight-bold py-3"style="color:black;font-size:15px;">Deductions</p>


<div class="row">
    <div class="col">
            <label for="">PAYE(Pay As You Earn)</label>
            <input type="number"name="paye"step="0.01" min="0.00"class="form-control"required>
    </div>


    <div class="col">
            <label for="">Pension Contribution</label>
            <input type="number"name="pension"step="0.01" min="0.00"class="form-control"required>
    </div>
</div>
...
<div class="row">
    <div class="col">
            <label for="">NHF</label>
            <input type="number"name="nhf"step="0.01" min="0.00"class="form-control"required>
    </div>


    <div class="col">
            <label for="">Loan & Others </label>
            <input type="number"name="loan"step="0.01" min="0.00"class="form-control"required>
    </div>
</div>
        ...
        <div class="text-center">
            <button class="bg-primary text-light py-2 rounded w-100 border-0">Create Employee Payslip</button>
