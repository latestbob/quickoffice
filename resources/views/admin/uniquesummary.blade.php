...
<!-- Content Row -->
                    ...
                    <div class="col-md-12 m-auto card px-0">
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-borderless table-hover">
                                ...
                                <tbody style="color:black;font-size:14px;z-index:100;">
    ...
    @if($task->status  == "pending")
        ...
        <p class="badge badge-success text-light badge-sm">{{$task->status}} </p>
  

    @else
    <p class="badge badge-danger text-light badge-sm">{{$task->status}} </p>
