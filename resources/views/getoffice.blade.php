...
@endif
    ...
    <header class="text-center mb-5 text-white">
      <div class="row mt-5">
        <div class="col-lg-7 mx-auto">
          <h1> Thanks for subscribing to QuickOffice</h1>
    ...
    <div class="col-md-7 rounded m-auto alert alert-success py-3">
          <h3 class="text-center">An Email have been sent to the registered company mail</h3>
<br>
<br>
