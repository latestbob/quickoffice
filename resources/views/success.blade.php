...
@endif
   ...
   <div class="col-md-6 m-auto rounded py-3"style="background:white;">
            
            <div class="bg-success text-center py-3">
                <i class="fas fa-check-circle"style="font-size:70px;color:white;"></i>
            </div>
            ...
            <div class="mt-5">
                ...
                <p class="text-center">Your office has been created successfully, </p>

                <div class="text-center">
                    <a href="{{$officeurl}}"class="btn btn-success text-center text-light rounded py-2">GET STARTED</a>
                </div>
            </div>
   </div>
