...
<head>
    ...
    <title>QuickOffice - Active Offices</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Active Subriptions - {{\App\Office::where('active','true')->count()}}</h1>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$offices->official_mail}}</td>
                                        <td>{{$offices->official_phone}}</td>
                                        <td>{{$offices->plan}}</td>
                                        <td>{{$offices->type}}</td>
                                        <td>{{$offices->reference}}</td>
                                        <td>{{$offices->customer_code}}</td>
                                        <td>{{\Carbon\Carbon::parse($offices->paid)->format('M-d-Y')}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
