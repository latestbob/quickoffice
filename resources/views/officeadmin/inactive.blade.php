...
<head>
    ...
    <title>QuickOffice Admin - Inactive Offices</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Inactive Subriptions - {{\App\Office::where('active','false')->count()}}</h1>
                               ...
                               <tbody>
                                @foreach($office as $off)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$off->customer_code}}</td>
                                        <td>{{$off->plan}}</td>
                                        <td>{{$off->type}}</td>
                                        <td>{{\Carbon\Carbon::parse($off->paid)->format('Y-m-d')}}</td>
                                    </tr>
                                @endforeach 
                               </tbody>
                           </table>
