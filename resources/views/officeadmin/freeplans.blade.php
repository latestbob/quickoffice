...
<head>
    ...
    <title>QuickOffice Admin - Freeplan Offices</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Freeplan Offices - {{\App\Office::where('plan','starterfree')->orWhere('plan','basicfree')->orWhere('plan','professionalfree')->orWhere('plan','businessfree')->orWhere('plan','enterprisefree')->count()}}</h1>
