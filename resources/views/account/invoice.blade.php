...
<head>
    ...
    <title>{{Auth::user()->office}} Account - Invoice</title>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Payment Invoice</h1>
                            ...
                            <div class="col-md-8 m-auto ">
                                ...
                                <form action="{{route('acccout.invoice.post')}}"method="POST">
                                    @csrf 
                                    ...
                                    <div class="form-group">
                                            ...
                                            <select name="client" id=""class="form-control"required>
                                                <option value="">Select From List of Clients</option>
                                    ...
                                    <div class="form-group">
                                            <label for="content">Description (Detailed Summary of Invoice)</label>
                                            <textarea class="form-control" id="summary-ckeditor2" name="description"placeholder="Detailed Summary of the Invoice"required></textarea>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-6">
                                                ...
                                                <input type="number"name="subtotal"placeholder="Subtotal"class="form-control"required>
                                            </div>

                                            <div class="col-6">
                                                <label for="">VAT (%)</label>
                                                <input type="number"placeholder="VAT"class="form-control"disabled>
                                            </div>
                                            <input type="hidden"name="vat"value="7.5"required>

                                            
                                        </div>
                                        <div class="form-group">
                                            <label for="">Shipping/Logistics (Optional)</label>
                                            <input type="number"name="shipping"placeholder="Enter Shipping Cost"class="form-control">
                                        </div>


                                        <div class="form-group">
                                            <button class="btn btn-success text-center">Generate Invoice</button>
                                        </div>
             ...
             <tbody>
                 @foreach($invoice as $in)
                    <tr>
                        <td> {{$in->invoiceid}}</td>
                        <td>{{$in->client}}</td>
                        <td>₦ {{ number_format($in->subtotal, 2) }}</td>
                        <td>{{$in->vat}} (%)</td>
                        <td>₦ {{ number_format($in->shipping, 2) }}</td>
                        <td>₦ {{ number_format($in->total, 2) }}</td>
                        <td><a href="{{route('account.invoice.generate',$in->id)}}"class="btn btn-sm btn-success">Generate</a></td>
