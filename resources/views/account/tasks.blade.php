...
<head>
    ...
    <title>{{Auth::user()->office}} Account - Tasks</title>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <label for="category">Task Category</label>
                                                <select  onchange="clientgetType();" name="category"class="form-control taskcategory"id=""required>
                                        ...
                                        <div class="staffdiv col-md-6 notshow">
       ...
       <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <form action="{{route('account.edit.task.put')}}"method="POST">
                            @csrf 
                            {{method_field('PUT')}}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('account.delete.taskdelete')}}"method="POST">
                        @csrf 
                        {{method_field('DELETE')}}
...
<script >
    ...
    function showId(e){
        let _id = e.target.dataset.id
        editTask('/account/tasks/edit/', _id)
...
//script for delete modal
    ...
    function showId(e){
        let _id = e.target.dataset.id
        deleteTask('/account/tasks/delete/', _id)
