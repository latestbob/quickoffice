...
<head>
    ...
    <title>{{Auth::user()->office}} Account - Profile</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <img src="{{asset('img/undraw_profile.svg')}}"class="py-2" alt=""style="width:200px;height:200px;float:left;">
                    </div>
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                    <tr>
                                        <td>Full Name</td>
                                        <td class="staff_name">{{Auth::user()->name}}</td>

                                    </tr>

                                    <tr>
                                        <td> Email Address</td>
                                        <td class="staff_email">{{Auth::user()->email}}</td>

                                    </tr>

                                    <tr>
                                        <td> Date of Birth</td>
                                        <td class="staff_dob" >{{Auth::user()->dob}}</td>

                                    </tr>
                                      
                                    <tr>
                                        <td>Contact Phone</td>
                                        <td class="staff_phone" >{{Auth::user()->phone}}</td>
                                    </tr>

                                    <tr>
                                        <td>Office Branch</td>
                                        <td class="staff_branch" >{{Auth::user()->branch}}</td>
                                    </tr>

                                    <tr>
                                        <td>Staff Role</td>
                                        <td class="staff_role" >{{Auth::user()->position}}</td>
                                    </tr>

                                    <tr>
                                        <td>Job Description</td>
                                        <td class="staff_description" >{{Auth::user()->description}}</td>
                                    </tr>
